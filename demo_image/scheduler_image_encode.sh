...
batch_sizes=(4096 8192 1 2 3 4 5 6 7 8 16 32 64 96 128 160 192 224 256 320 384 448 512 640 768 896 1024 1280 1536 1792 2048)
# batch_sizes=(672)
...
for bs in "${batch_sizes[@]}"; do
    ...
    # 带错误处理的调用
    if ! bash monitor_image_encode.sh $bs; then
